...
$(document).ready(function () {
    editor = new $.fn.dataTable.Editor({
        ajax: {
            create: {
                type: 'POST',
                url: 'rest/sm/smadvertisement/save',
                data: function (d) {
                    return {'rows': JSON.stringify(d)};
                }
            },
            edit: {
                type: 'POST',
    ...
    var table = $('#dtable').DataTable({
        ...
        "ajax": {
            "url": "/rest/sm/smadvertisement/list",
            "type": "POST",
            "data": function (d) {
        ...
        "columns": [
            ...
            {"data": "pageIndex", "orderable": false},
            {"data": "imgUrl", "orderable": false,
            "render":function (data,type,row) {
                return '<img src=\"'+data+'\" width=\"80px\" height=\"100px\" />';
            }},
            {"data": "linkUrl", "orderable": false},
            {"data": "showIndex", "orderable": false},
            {"data": "status", "orderable": false},
            {"data": "appType", "orderable": false},
            {"data": "validBeginDate", "orderable": false},
            {"data": "validEndDate", "orderable": false},
