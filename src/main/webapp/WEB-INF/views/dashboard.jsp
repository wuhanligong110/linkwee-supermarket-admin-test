...
<div class="container-fluid">
	<div class="row">
       ...
       <div class="col-sm-2" style="min-width: 100px;">          
			<a href="http://10.16.0.210/index.html" class="easyui-linkbutton btn btn-default" >数据分析报表</a>	
       </div>
    </div>
    ...
    <div class="row">
	    ...
	    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
	        <div class="dashboard-stat red">
	            ...
	            <div class="detailsDef">
	                <div id="newFirstInvestor" class="number"></div>
	            </div>
	            <a class="more" href="#">新增T呗首投人数（人）<i class="m-icon-swapright m-icon-white"></i>
	            </a>
	        </div>
	    </div>
	    ...
	    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
	        <div class="dashboard-stat red">
	            ...
	            <div class="detailsDef">
	                <div id="totalFirstInvestor" class="number"></div>
	            </div>
	            <a class="more" href="#">累计T呗首投人数（人）<i class="m-icon-swapright m-icon-white"></i>
	            </a>
	        </div>
	    </div>		    
	</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div id="firstInvestorStatistics" style="min-height: 300px;"></div>
        </div>      
    </div>
 ...
 .tickLabel
{
 ...
 function loadView(path,params){
	 ...
	 $.getJSON(path,params, function (json) {
		 ...
		 $('#newFirstInvestor').text((json.data.count.newFirstInvestor==undefined?0:json.data.count.newFirstInvestor));
		 ...
		 $('#totalFirstInvestor').text(json.data.count.totalFirstInvestor);
		 ...
		 var firstInvestorCategories = [];  
		 var firstInvestorValues = [];
		 ...
		 var firstInvestorData = json.data.firstInvestor;
		 $.each(firstInvestorData,function(i,data){
			 firstInvestorCategories.push(data.firstInvestorTime);
			 firstInvestorValues.push(data.firstInvestorNum);
		 });
		 ...
		 var firstInvestorStatistics = echarts.init(document.getElementById('firstInvestorStatistics'));
		 var firstInvestorOption = {
			 title: {
			        text: '新增T呗首投人数'
			 },
		     tooltip: {
		     ...
		     series: [{
		         name: '人数',
		         type:'line',
		         data: firstInvestorValues
		     }]
		 };
		 firstInvestorStatistics.setOption(firstInvestorOption);
