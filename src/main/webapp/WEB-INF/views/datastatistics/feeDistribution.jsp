...
<%@ page import="com.finance.xoss.rbac.PermissionSign" %>
	...
	<div class="row">
		...
		<div class="col-sm-7 col-sm-offset-1">
			...
			<div class="row">
				...
				<shiro:hasPermission name="<%=PermissionSign.FEE_MAX_TOP100_EXPORT%>">
				<div class="col-sm-4">
						<a class="btn btn-default J_topListDownload"  href="javascript:;" role="button"><i class="fa fa-download"></i> 导出</a>
				</div>
				</shiro:hasPermission>
			</div>
...
<script type="text/javascript" >
 $(document).ready(function() {
	 ...
	 var feeDistributionRatio_chart = echarts.init(document.getElementById('feeDistributionRatio_chart'));
        start();
        $("button.J_search").click(function(event) {
              start();
        });

          $("a.J_topListDownload").click(function(event) {
            var data = getParameters();
            $(this).attr("href" ,'rest/feeDistribution/topListDownload?'+milo.serialize(data));
        });
