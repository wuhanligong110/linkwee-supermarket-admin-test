...
public class PermissionController {
    ...
    @ResponseBody
    public PageInfo<Permission> getPermissions(@RequestParam("pageNo") int pageNo, @RequestParam("pageSize") int pageSize) {
        Page<Permission> permissions = permissionService.selectList(pageNo,pageSize);
