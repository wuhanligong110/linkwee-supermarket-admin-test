...
public class DateUtils {
	 ...
	 * @return 　　
	 */
	public static Date parseTimestampStr(String timestampStrDate) {
		try {
			return parse(new Timestamp(new Long(timestampStrDate)), getDatePattern());
